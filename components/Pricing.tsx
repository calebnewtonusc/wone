  ...
  return (
    <section id="pricing" ref={ref} className="bg-gray-50 py-28 px-6 border-t border-gray-100">
      <div className="max-w-5xl mx-auto">
        ...
        >
          <p className="text-xs font-semibold tracking-widest uppercase text-blue-600 mb-3">Pricing</p>
          <h2 className="text-4xl md:text-5xl font-bold tracking-tight text-gray-900 mb-4">
            Simple, transparent pricing.
          </h2>
          <p className="text-lg text-gray-500 max-w-md mx-auto">No hidden fees. Cancel anytime. Free during beta.</p>
        </motion.div>
